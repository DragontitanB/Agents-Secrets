...
import AboutScreen from './Screens/About'; // Asegúrate de que el nombre del archivo sea correcto
...
export default function App() {
  ...
  const loadDatabase = async () => {
    const dbName = '911_Tarea7.db';
    const dbAsset = require('./assets/911_Tarea7.db');
